...
export default function CreateConcours() {
  ...
  return (
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      ...
      <h1 className='text-center text-3xl my-7 font-semibold'>Create a concours</h1>
    ...
    <Label value='Title of speciality'/>
      ...
      <div className='flex flex-col gap-4 sm:flex-row'>
       ...
       <TextInput type='number' placeholder='Number of post' required id='title'className='flex-1' onChange={(e) => setFormData({ ...formData, postNumber: e.target.value })}/>
        </div>
        <Label value='Start Date'/>
        <div className='flex flex-col gap-4 sm:flex-row'>
        <TextInput type='date' placeholder='Start date' required id='date'className='flex-1' onChange={(e) => setFormData({ ...formData, dateStart: e.target.value })}/> 
        
        </div>
        <Label value='End Date'/>
      <div className='flex flex-col gap-4 sm:flex-row'>
        <TextInput type='date' placeholder='End date' required id='date'className='flex-1' onChange={(e) => setFormData({ ...formData, dateEnd: e.target.value })}/>
        </div>
