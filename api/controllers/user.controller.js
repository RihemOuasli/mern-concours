...
export const updateUser = async (req, res, next) => {
      ...
      if(req.body.username){
        ...
        try {
           const updateUser = await Utilisateur.findByIdAndUpdate(req.params.userId,{
             $set: {
...
export const deleteUser = async (req, res, next) => {
   ...
   try {
    await Utilisateur.findByIdAndDelete(req.params.userId);
...
const lastMonthUsers = await Utilisateur.countDocuments({
